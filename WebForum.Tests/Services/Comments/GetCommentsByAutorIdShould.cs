...
{
    [TestClass]
    public class GetCommentsByAutorIdShould
    {
        [TestMethod]
        public void ReturnAllComments_When_ParametersAreValid()
        {
            ...
            List<Comment> expectedComments = TestHelper.CommentsHelper.GetTestComments().Where(c => c.AutorId == 1).ToList();

            var repositoryMock = new Mock<ICommentRepository>();

            repositoryMock
                .Setup(r => r.GetByAuthorId(1))
            ...
            List<Comment> actualComments = sut.GetByAuthorId(1);
        ...
        public void ThrowException_When_CommentsNotFound()
        {
            ...
            repositoryMock
                .Setup(r => r.GetByAuthorId(It.IsAny<int>()))
            ...
            Assert.ThrowsException<EntityNotFoundException>(() => sut.GetByAuthorId(It.IsAny<int>()));
        }
    }
}
